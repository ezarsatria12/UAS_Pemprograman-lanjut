<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminsignin.aspx.cs" MasterPageFile="~/page/auth/auth.master" Inherits="UAS_Pemprogramanlanjut_2203040104.page.auth.adminsignin" %>
            ...
            <div class="h-screen flex flex-row">
                <div class="flex flex-col w-full justify-center gap-8">
                    <div class="flex flex-col gap-2">
                        <h2 class="font-primary font-medium text-3xl">Hello master!</h2>
                    ...
                    <asp:Button runat="server" CssClass="block px-4 py-2 rounded-lg bg-white font-primary text-white font-medium hover:shadow-lg" Text="Login" Style="background-color: #658864;" />
                </div>
            </div>
        </form>
    </div>
