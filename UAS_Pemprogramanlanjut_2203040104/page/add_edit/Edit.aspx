<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" MasterPageFile="~/page/add_edit/add_edit.master"  Inherits="UAS_Pemprogramanlanjut_2203040104.page.add_edit.Edit" %>
        ...
        <form id="Form1" runat="server">
            <div class="h-screen flex flex-row">
                <div class="flex flex-col w-full justify-center gap-8">
                    ...
                    <asp:Button runat="server" CssClass="block px-4 py-2 rounded-lg bg-white font-primary text-white font-medium hover:shadow-lg" Text="Edit" Style="background-color: #658864;" OnClick="Btn_edit"/>
                </div>
            </div>
        </form>
    </div>
